...
### Owner sample ingestion (2026-09-10 — 80 images in five batches)
| Capability | Status | Evidence | Honest limitation |
|---|---|---|---|
| 29 owner cases (BS-GPC-0003…0032) as structured construction lessons | WORKING | `test_golden_production_memory.py` (17 tests, 31 cases seed idempotently); `docs/reference/owner-samples/README.md` index | No text read off photos: every owner case is `customer_source_text=None`, pending tier; lessons are human-curated, not measured |
